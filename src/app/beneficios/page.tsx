...
export default function BeneficiosPage() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setShowModal(false);
      setForm({ nombre: "", descripcion: "", icono: "🎁", costo_puntos: "" });
                          ...
                          <div style={{ display: "flex", gap: 4 }}>
                            <button
                              ...
                              style={{
                                ...
                                cursor: "pointer",
                                fontFamily: "inherit",
                                background: "rgba(255,90,80,0.15)",
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (canCreate) e.currentTarget.style.opacity = "0.85";
                }}
                onMouseLeave={(e) => {
